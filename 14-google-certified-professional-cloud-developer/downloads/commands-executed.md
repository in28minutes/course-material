...
Additional for Professional Cloud Developer
```
...
kubectl create deployment hello-world-rest-api-error --image=in28min/hello-world-rest-api-error:0.0.1.RELEASE
kubectl get pods
kubectl logs hello-world-rest-api-687d9c7bc7-pltgz
kubectl get pods
kubectl exec -it hello-world-rest-api-687d9c7bc7-pltgz -- ls
kubectl exec -it hello-world-rest-api-687d9c7bc7-pltgz -- ls -l
kubectl exec -it hello-world-rest-api-687d9c7bc7-pltgz -- ls -l /tmp
kubectl scale deployment hello-world-rest-api --replicas=300
kubectl describe pods hello-world-rest-api
kubectl scale deployment hello-world-rest-api --replicas=1
kubectl delete deployment hello-world-rest-api-error
...
gcloud container clusters create my-istio-cluster --project=my-kubernetes-project-304910     --zone=us-central1-a      --machine-type=e2-standard-4     --num-nodes=2
gcloud container clusters get-credentials my-istio-cluster      --project=my-kubernetes-project-304910     --zone=us-central1-a
curl https://storage.googleapis.com/csm-artifacts/asm/install_asm_1.10 > install_asm
curl https://storage.googleapis.com/csm-artifacts/asm/install_asm_1.10.sha256 > install_asm.sha256
sha256sum -c --ignore-missing install_asm.sha256
chmod +x install_asm
./install_asm   --project_id my-kubernetes-project-304910   --cluster_name my-istio-cluster    --cluster_location us-central1-a    --mode install   --output_dir ./asm-downloads   --enable_all
kpt pkg get https://github.com/GoogleCloudPlatform/microservices-demo.git/release online-boutique
kubectl create namespace demo
kubectl -n istio-system get pods -l app=istiod --show-labels
kubectl label namespace demo istio-injection- istio.io/rev=asm-1102-3 --overwrite
kubectl apply -n demo -f online-boutique
kubectl get service istio-ingressgateway -n istio-system
gcloud container clusters delete  my-istio-cluster      --project=my-kubernetes-project-304910     --zone=us-central1-a
```
...
```
gcloud source repos clone hello-world-python --project=cloud-build-project-319012
git add *
git config --global user.email "ranga@in28minutes.com"
